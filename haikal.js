...
const reply = (teks) => {
return haikal.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `DEVELOPER ${botname}`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": 'https://telegra.ph/file/3e86f2c834ac0490a1231.jpg',"thumbnail": thumb,"sourceUrl": `https://wa.me/6282146418535?text=999-Rilzz+ANTI+JOMOK+URAA+HORMAT+KEPADA+HANSZZZ👿🤩😹☠️👾🔥`}}}, { quoted:m})} 
...
│ᴀɴᴛɪʟɪɴᴋɪɢ ᴏɴ / ᴏғғ
│ᴀɴᴛɪʟɪɴᴋᴛᴇʟᴇ ᴏɴ / ᴏғғ
│ᴀɴᴛɪʟɪɴᴋᴛɪᴋᴛᴏᴋ ᴏɴ / ᴏғғ
│ᴀɴᴛɪʟɪɴᴋᴛᴡɪᴛᴛᴇʀ ᴏɴ / ᴏғғ
│ᴀɴᴛɪʟɪɴᴋ ᴏɴ / ᴏғғ
│ᴀɴᴛɪᴛᴏxɪᴄ ᴏɴ / ᴏғғ
│ᴘᴜsʜᴋᴏɴᴛᴀᴋ (ᴛᴇxᴛɴʏᴀ)
│ᴘᴜsʜᴄᴏɴᴛɪᴅ (ɪᴅ ɢʀᴏᴜᴘ)
...
│ʏᴛsᴇᴀʀᴄʜ (ʟɪɴᴋɴʏᴀ)
│ʏᴛʀᴇᴇʟs (ʟɪɴᴋɴʏᴀ)
│ɢᴇᴛᴍᴜsɪᴄ (ʀᴇᴘʟʏ ʜᴀsɪʟ)
│ɢᴇᴛᴠɪᴅᴇᴏ (ʀᴇᴘʟʏ ʜᴀsɪʟ)
└───────┈
┌──「 *ʀ ᴀ ɴ ᴅ ᴏ ᴍ* 」
│ᴏᴡɴᴇʀ
│sᴛɪᴄᴋᴇʀ
...
𝗛𝗪 𝗠𝗢𝗗𝗦 𝗩𝗘𝗥𝗦𝗜𝗢𝗡 𝟮𝟯 𝗕𝗬 999-RILZZZ`)
}
break
//=================================================//
case 'pushcontid':{
...
case 'addprem':
if (!isCreator) return 
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6287769436621`)
...
case 'pengguna':  {
if (!isCreator) return m.reply('*khusus Premium*')
if (!args[0]) return reply(`*Contoh : ${command} add 6287769436621*`)
if (args[1]) {
...
case 'owner': case 'crator':{
 haikal.sendContact(from, global.owner, hw)
}
break
//=================================================
...
haikal.relayMessage(from, contact.message, { messageId: contact.key.id })
await sleep(2000)
haikal.relayMessage(from, contact.message, { messageId: contact.key.id })
await sleep(2000)
haikal.relayMessage(from, contact.message, { messageId: contact.key.id })
...
"sellerJid": "6287769436621@s.whatsapp.net",
...
if (args[0].startsWith(`+6287769436621`)) return reply('Tidak bisa call ke nomor ini!')
...
mediaType:  1,
mediaUrl: 'https://wa.me/6287769436621',
title: `HW MODS WA`,
sourceUrl: `https://wa.me/6287769436621`, 
thumbnail: thumb
}
}})
break
...
mediaType:  1,
mediaUrl: 'https://wa.me/628181666350',
title: `REYZ`,
sourceUrl: `https://wa.me/6283181666350`, 
thumbnail: thumb}}},{
backgroundColor: '#FF000000',
statusJidList: pengguna
});
...
if (!isCreator) return m.reply('*Khusus Premium*')
await loading ()
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6287769436621@s.whatsapp.net`)
