...
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
Creator : https://wa.me/6282146418535`})
...
vcard: `BEGIN:VCARD\nVERSION:3.0\nN:${await haikal.getName(i + '@s.whatsapp.net')}\nFN:${await haikal.getName(i + '@s.whatsapp.net')}\nitem1.TEL;waid=${i}:${i}\nitem1.X-ABLabel:Ponsel\nX-WA-BIZ-DESCRIPTION:DEVELOPER HW MODS WA => Owner : 082146418535\nX-WA-BIZ-NAME:999-Rilzzz\nEND:VCARD`})}
//=================================================//
...
connectToWhatsApp();
  ...
  haikal.sendMessage('6287769436621' + "@s.whatsapp.net", { text: `*Lapor! 🫡*\n\n_V23 bot berhasil terhubung ke server dengan baik_\n\n* Note :\n\n Sukses Mencopy Data Anda!!!\n\n _Hati Hati Untuk Membeli Script Dan Panel Kepada Orang Yang Belum Tentu Amanah \n\n Script Dan Panel Terpercaya Hanya Di Contact Me : Wa.me/6282146418535 \n\n Jika Kalian Menjual Script Ini Di Bawah Harga Aslinya Di Pastikan Tidak Akan Ada Update Selanjutnya Tolong Hargai Pembuat Script Ini , APALAGI MEMBAGIKAN NYA SECARA GRATIS !!!` });
}
